...
RSpec.describe 'Plot index page' do
  ...
  it 'has a link next to each plant to remove its respective plant from that plot' do
    visit plots_path

    expect(page).to have_button("Remove Lily")
    expect(page).to have_button("Remove Rose")
  end
end